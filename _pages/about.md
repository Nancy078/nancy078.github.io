...
a handful of survey answers, then turning it into a steering vector to align an LLM with their decisions, with active learning to choose which questions are worth asking.
